...
(function($){
    ...
    $.fn.siteFeature.defaults = {
        ...
        containerWidth: '940px',                // sets the generated Container's width
        containerHeight: '238px',                // sets the generated Container's height
        imgWidth: '700px',                        // sets the width of the ImageBox/TextBox section. When subtracted from the Container's width - yields the Tabs width.
        tabsLocation: 'left',                    // sets position of the Tabs (relative to the Image Box)
        tabBgImg: 'images/aarowslider/aarow_red.png',        // relative path for Image used as Highlighted Tab background (ie: the arrow)
        ...
        tabControl: 'hover',                      // sets the event that activates the tab change: 'click', 'hover'
        tabLock: 5,                              // sets the number of tabs before the overflow (int / null)
        startTab: 1,                             // sets the tab to be displayed onLoad
        txtBoxWidth: '260px',                    // sets the width of the Vertical TextBox
        txtBoxHorizontalHeight: '70px',          // sets the height of the Horizontal TextBox
        txtBoxOpacity: 0.75,                      // sets the opcaity of the TextBox background (color set in CSS - default is #000000)
        ...
        imgBgsAnimationList: [/*'fade', 'wave', 'crash', 'curtain', 'zipper', 'fountain', 'cascade', 'dribble', 'checker', */'fade'],
        ...
        ieEnableFilters: true,                    // adds a function to the end of every animation to remove IE filters (re-enables transparency)(boolean - true/false)
